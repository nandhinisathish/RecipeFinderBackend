...
const favouriteSchema = new mongoose.Schema({
  ...
  thumbnail: { type: String, default: "" }, // Optional field, default to empty string
  sourceUrl: { type: String, default: "" }, // Optional field
  youtubeUrl: { type: String, default: "" }, // Optional field
  origin: { type: String, default: "" }, // Optional field
  tags: { type: [String], default: [] }, // Optional array
